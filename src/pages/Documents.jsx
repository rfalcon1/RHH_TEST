...
export default function Documents(){
  ...
  return (<section className="space-y-6">
    <div className="flex items-end justify-between gap-4">
      <div><h1 className="text-3xl font-extrabold" style={{color:'rgb(var(--c1))'}}>Documentos</h1><p className="text-sm text-gray-600">Preview integrado (PDF, imágenes, HTML). Botón de visor alternativo si el dominio bloquea el embed.</p></div>
