...
export default function Directory(){
  ...
  return (<section className="space-y-6">
    <div className="flex items-end justify-between gap-4">
      <div><h1 className="text-3xl font-extrabold text-sky-700">Directorio</h1><p className="text-sm text-gray-600">Busca por nombre, cargo o asistencia.</p></div>
      <input className="input max-w-md" placeholder="Buscar por nombre, cargo o asistencia..." value={query} onChange={e=>setQuery(e.target.value)} />
    </div>
